...
public class ReadMaterialAdapter implements IReadMaterialPort {
    ...
    @Override
    public List<Material> filterAllMaterial(IPaging paging, String searchType, String searchValue, String sortType, String sortValue) {
        return  materialDBIRepository.filterAllMaterial(paging,searchType,searchValue,sortType,sortValue)
                .stream()
                .map(MaterialMapperOutput::toDomain)
                .toList();
    }
    ...
    @Override
    public List<Material> filterAllMaterial(String searchType, String searchValue, String sortType, String sortValue) {
        return materialDBIRepository.filterAllMaterial(searchType,searchValue,sortType,sortValue)
                .stream()
                .map(MaterialMapperOutput::toDomain)
                .toList();
    }

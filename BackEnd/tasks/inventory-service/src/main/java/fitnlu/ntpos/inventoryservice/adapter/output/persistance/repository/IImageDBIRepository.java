...
public interface IImageDBIRepository {
    ...
    List<MaterialEntities> filterAllMaterial(IPaging paging, String searchType, String searchValue, String sortType, String sortValue);
    List<MaterialEntities> filterAllMaterial(String searchType, String searchValue, String sortType, String sortValue);

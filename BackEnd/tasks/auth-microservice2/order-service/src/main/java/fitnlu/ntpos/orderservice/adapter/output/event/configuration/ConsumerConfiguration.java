...
public class ConsumerConfiguration {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(org.apache.kafka.clients.consumer.ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, getPropertiesBean.getBootstrapServer());
        configurations.put(org.apache.kafka.clients.consumer.ConsumerConfig.GROUP_ID_CONFIG, "kafka-group");

...
import { detailOrder, detailOrderFailure, detailOrderSuccess } from "../orders/ordersSilce";
...
function* fetchDetailReceiptOrderSaga(action: ReturnType<typeof detailOrder>) {
  try {
    const { data } = yield call(payment.query, {

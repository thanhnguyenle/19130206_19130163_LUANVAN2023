...
const DetailExportProductScreen = ({ navigation }: any) => {
    ...
    return (
        <View style={styles.container}>
            <ScrollView
                ...
                <View style={styles.box}>
                    <View style={styles.left}>
                        <FontAwesome name="comment-o" size={20} color={COLORS.color_grey} style={{ paddingLeft: 10, paddingRight: 10 }} />
                        <Text style={styles.text}>Trạng thái</Text>
                    </View>
                    <Text style={[styles.text, { fontWeight: '400', color: COLORS.color_black, fontSize: responsiveFontSize(2.1) }]}>Đã trả</Text>
                </View>
                <View style={styles.box}>
                    <View style={styles.left}>
                ...
                <View style={styles.boxListFood}>
                    ...
                    <View style={styles.box}>
                        <View style={styles.left}>
                            <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.color_black }]}>Tổng đã giảm giá</Text>
                        </View>
                        <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.darkGreen, fontWeight: '500' }]}>480000</Text>
                    </View>
                    <View style={styles.box}>
                        <View style={styles.left}>
                            <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.color_black }]}>Phí trả hàng</Text>
                        </View>
                        <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.darkGreen, fontWeight: '500' }]}>480000</Text>
                    </View>
                    <View style={styles.box}>
                        <View style={styles.left}>
                            <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.color_black }]}>Cần trả khách</Text>
                        </View>
                        <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.darkGreen, fontWeight: '500' }]}>480000</Text>
                    </View>
                    <View style={styles.box}>
                        <View style={styles.left}>
                            <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.color_black }]}>Tiền trả khách</Text>
                        </View>
                        <Text style={[styles.text, { fontSize: responsiveFontSize(2.2), color: COLORS.darkGreen, fontWeight: '500' }]}>480000</Text>
                    </View>
                </View>
...
export default DetailExportProductScreen;
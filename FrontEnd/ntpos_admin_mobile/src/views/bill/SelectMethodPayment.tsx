...
import { paymentMethod, paymentMethodNull } from "../../redux_store/payment/PaymentSlice";
    ...
    <SafeAreaView style={styles.container}>
        ...
        >
          <View style={[{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }]}>
            <View style={styles.box1}>
              <Image source={require('../../assets/paymethod.png')} style={{ width: '100%', height: '100%', borderRadius: 10 }} />
            </View>
      ...
      <View style={styles.container1}>
        ...
        >
          <View style={[{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }]}>
            <View style={styles.box1}>
              <Image source={require('../../assets/paypad.png')} style={{ width: '100%', height: '100%', borderRadius: 10 }} />
            </View>
            <View style={styles.box2}>

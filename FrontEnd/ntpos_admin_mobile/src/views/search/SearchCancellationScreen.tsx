...
const SearchCancellationScreen = () => {
        ...
        <View>
            <ScrollView>
                ...
                <View style={styles.boxSearch}>
                    ...
                    <TextInput placeholder='Mã phiếu xuất hủy' style={{ fontSize: responsiveFontSize(2.1), width: '80%', }}></TextInput>
                </View>
...
export default SearchCancellationScreen;
        ...
        <View>
            <ScrollView>
                ...
                <View style={styles.boxTypeCheck}>
                    ...
                    <ButtonCheck title='Đã trả hàng' isChecked={da_tra_hang} onPress={() => {
                        setDaTraHang(!da_tra_hang);
                    }} />
...
export default SearchReturnImportGoods;
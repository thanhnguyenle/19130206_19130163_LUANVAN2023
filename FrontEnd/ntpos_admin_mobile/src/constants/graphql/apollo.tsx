...
import { clientUri, inventoryUri, orderUri, paymentUri, productUri } from "../LinkAPI";
...
const httpLinkInventory = createHttpLink({
    uri: inventoryUri, // Thay thế bằng endpoint API của bạn
});
...
const inventory = new ApolloClient({
    link: authLink.concat(httpLinkInventory),
    cache: new InMemoryCache(),
    defaultOptions: {
        watchQuery: {
            fetchPolicy: 'no-cache',
...
export { client, product, order,payment ,inventory};

...
const NumberTwoButton = (props) => {
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.button} onPress={decrease} disabled={(number <= 1) ? true : false}>
                <Text style={styles.title}>-</Text>
            </TouchableOpacity>
            <TextInput {...props} style={styles.input} />
            <TouchableOpacity style={styles.button} onPress={increase} disabled={(number >= 20) ? true : false}>
                <Text style={styles.title}>+</Text>
            </TouchableOpacity>
        </View>
    )

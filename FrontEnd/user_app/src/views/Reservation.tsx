...
import { covers } from '../constants/data';
import ButtonComponent from '../components/ButtonComponent';
const Reservation = ({ navigation, route }: any) => {
            ...
            <SafeAreaView>
                <View style={styles.containerCover}>
                    ...
                    <View style={styles.boxInformationStore}>
                        ...
                        <Text
                            style={{ color: COLORS.color_grey, fontSize: 14, marginTop: 4 }}
                        >
                            11/13 Trần Đại Nghĩa
                        </Text>
                    </View>
                </View>
                <View style={styles.boxInformationOrder}>
                    ...
                    <View style={styles.option}>
                        ...
                        <View>
                            <TouchableOpacity onPress={() => showMode('date')}>
                                <Text style={{ color: COLORS.darkGreen, fontWeight: '500' }}>
                                    {dateTime}
                                </Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.optionNote}>
                        ...
                        <TextInput value={note} onChangeText={(note: string) => setNote(note)} />
                    </View>
                    <View style={styles.viewButton}>
                        <ButtonComponent title='Đặt ngay' onPress={() => { }} />
                    </View>
                </View>
            </SafeAreaView>
        </View>

...
const ItemOrder: React.FC<ItemOrderProps> = (props) => {
    ...
    return (
        <TouchableOpacity
            ...
            onPress={() => {
                props.navigation.navigate('OrderDetail', { order: props.item });
            }}
        >
            ...
            <View style={styles.information}>
                ...
                <Text style={styles.text}>
                    Số lượng người: {props.item.memberNumber}
                </Text>
                <Text style={styles.text}>Thời gian: {props.item.time}</Text>
                <Text style={[styles.text, { color: 'green' }]}>
                    Trạng thái: {stringStatus(props.item.status)}
                </Text>
            </View>
